...
### `src/features/landing-hero/components/PortalVideoCarousel.tsx`
```typescript
...
export const MEDIA_URLS = {
  ...
  popify1: '/materials/popify-1.mp4',
  popify2: '/materials/popify-2.mp4',
  popify3: '/materials/popify-3.mp4',
  popify4: '/materials/popify-4.mp4',
} as const

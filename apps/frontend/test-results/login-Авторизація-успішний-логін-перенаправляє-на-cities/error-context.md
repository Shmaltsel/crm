...
- Name: login.spec.ts >> Авторизація >> успішний логін перенаправляє на /cities
...
```yaml
- heading "Вхід у CRM" [level=1]
- text: Невірний email або пароль Email
- textbox: admin@crm.com
- text: Пароль
- textbox: admin123
- button "Увійти"
```

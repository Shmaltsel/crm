        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <button
            onClick={async () => {
              ...
              if (
                !window.confirm(
                  ` Наразі імпорт доступний для наступних міст:Львів, Івано-Франківськ, Чернівці, Тернопіль, Ужгород Імпортувати всі школи з isuo.org для міста ${selectedCity.name}? Це може зайняти 1-2 хвилини.`,
                )
              )
                return;
              try {

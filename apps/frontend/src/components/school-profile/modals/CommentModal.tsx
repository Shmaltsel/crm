        ...
        >
          ...
          >
            ...
            <div className="p-5 sm:p-6 border-b border-border flex justify-between bg-surface-muted shrink-0">
              ...
              <button ref={closeRef} onClick={onClose} aria-label="Закрити" className="text-content-muted p-2 -mr-2 active:scale-90 transition-transform duration-fast">✕</button>
            </div>
            <form onSubmit={onSave} className="p-5 sm:p-6 flex-1 flex flex-col">
              ...
              <textarea
                ...
                className="w-full p-3 border border-border-strong rounded-xl focus:ring-2 focus:ring-blue-500 resize-none h-32 flex-1 min-h-[120px]"
                autoFocus
                required={mode === 'add_comment'}
              />
              <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 mt-6 shrink-0 pb-1 sm:pb-0">
                <button type="button" onClick={onClose} className="w-full sm:w-auto px-5 py-3 sm:py-2.5 text-content-secondary bg-surface-muted hover:bg-surface-muted rounded-xl font-medium transition-colors">
                  Скасувати
                </button>

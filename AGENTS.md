...
- перел складнимим візуальними змінами обов'язково затверджувати їх, описувати текстуально, як це виглядатиме
- після кожного фіксу, якщо ти виправляєш якісь баги, в кінці надай список, що потрібно перевірити після твоїх виправлень
